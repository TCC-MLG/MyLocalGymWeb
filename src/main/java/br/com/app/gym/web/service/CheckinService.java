...
public interface CheckinService {
    ...
    public boolean liberarCliente(Integer checkinId, Integer clienteId, Integer academiaId, boolean liberado, BigDecimal servicoId) throws ClientErrorException;
